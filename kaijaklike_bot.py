    ...
    for i, u_id in enumerate(targets, 1):
        try:
            if message.photo:
                ...
                bot.send_voice(int(u_id), message.voice.file_id, caption=message.caption or "")
            else:
...
# ═══════════════════════════════════════════════════════════
#  VOICE HANDLER — Admin ផ្ញើសារជា Voice (ឧ. សម្រាប់ ផ្សព្វផ្សាយ)
# ═══════════════════════════════════════════════════════════
